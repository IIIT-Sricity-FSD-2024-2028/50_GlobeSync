...
function logout() {
  // Clear all storage mechanisms to prevent auth state inconsistencies
  sessionStorage.clear();
  localStorage.removeItem("currentUser");
  localStorage.removeItem("role");
  localStorage.clear(); // Safe full sweep for this demo
...
const AuthFallback = {
  isLoggedIn: () => !!sessionStorage.getItem('user') || !!localStorage.getItem('currentUser'),
  getRole: () => sessionStorage.getItem('role') || localStorage.getItem('role'),
  getUser: () => JSON.parse(sessionStorage.getItem('user')) || JSON.parse(localStorage.getItem('currentUser'))
};
